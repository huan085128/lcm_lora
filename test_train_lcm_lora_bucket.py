...
def parse_args():
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/home/fintune/lcm-xl-distilled_Songyun",
...
class AspectRatioDataset(DistillationDataset):
    ...
    def transformer(self, image, size):
        ...
        if self.center_crop:
            # print(new_image.height, new_image.width, h, w)
        ...
        if self.debug:
            ...
            torchvision.utils.save_image(self.denormalize(new_image), f"/home/test/{filename}_1.jpg")
            torchvision.utils.save_image(torchvision.transforms.ToTensor()(image), f"/home/test/{filename}_2.jpg")
...
def main(args):
    ...
    logger.info(f"  Num batches each epoch = {len(train_dataset)}")
